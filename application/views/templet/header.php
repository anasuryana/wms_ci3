...
<head>	
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/jeui/themes/metro-blue/easyui.css"); ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/jeui/themes/icon.css"); ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/jeui/themes/color.css"); ?>">
	...
	<script type="text/javascript" src="<?php echo base_url("assets/jeui/jquery.easyui.min.js"); ?>"></script>	
	...
	<script type="text/javascript" src="<?php echo base_url("assets/js/onscan.min.js"); ?>"></script>
