        ...
        <div class="row">
            <div class="col-md-6 mb-1">
                <div class="input-group input-group-sm mb-1">
                    ...
                    <input type="text" class="form-control" id="ret_txt_feedr" required>                   
                </div>
            </div>
            <div class="col-md-6 mb-1">
                ...
                <div class="form-check-inline">
                    <label class="form-check-label">
                        <input type="radio" id="ret_ckyes" class="form-check-input" name="optradio" value="1" checked>Yes
                    </label>
                </div>
                <div class="form-check-inline">
                    <label class="form-check-label">
                        <input type="radio" id="ret_ckno" class="form-check-input" name="optradio" value="0">No
                    </label>
                </div>
            </div>  
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-1">
                <div class="input-group input-group-sm mb-1">
                    ...
                    <select class="form-control" id="ret_sel_country">
                        <?php 
                            $toprint = '';
                            foreach($lmade as $r){
...
<script>
    $("#ret_divku").css('height', $(window).height()*39/100);
    ...
    $("#ret_txt_befqty").keypress(function (e) {
        if(e.which==13){
            ...
            if(mval.substring(0,3)=='3N2'){
                ...
                let mfeeder = document.getElementById('ret_txt_feedr').value;
                ...
                $.ajax({
                    type: "GET",
                    url: "<?=base_url('RETPRD/checklot')?>",
                    data: {inpsn : mpsn, incat: mcat, inline: mline, infeeder:mfeeder, initem: mitemcd, inlot: mlot , inqty: mqty},
                    dataType: "json",
    ...
    function setHeadisRO(sts){
        ...
        $("#ret_txt_feedr").prop('readonly', sts);
    ...
    $("#ret_txt_feedr").keypress(function (e) { 
        if(e.which==13){            
            psnret_getdata();
        }
    });
    ...
    $("#ret_txt_itmcd").keypress(function (e) { 
        if(e.which==13){
            ...
            if(mfedr.trim()==''){
                document.getElementById('ret_txt_feedr').focus();
            ...
            $.ajax({
                type: "get",
                url: "<?=base_url('SPL/checkPSN_itmret')?>",
                data: {inpsn: mpsn, incat: mcat, inline: mline, infr: mfedr, incode : mval},
                dataType: "json",
                success: function (response) {
                    if(response.data[0].cd==0){
                        alertify.warning(response.data[0].msg);
    ...
    $("#ret_btn_save").click(function (e) { 
        ...
        $.ajax({
            ...
            data: {inpsn: mpsn, incat: mcat, inline: mline, infr: mfedr, initmcd: mitemcd, inrohs: mrohs, inqtybef: mqtybef,
             inqtyaft: mqtyaft, inlot: mlot, incountry : mcountry},
            dataType: "text",
            success: function (response) {
                alertify.message(response);psnret_getdata();
