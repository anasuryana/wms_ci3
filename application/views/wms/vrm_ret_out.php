...
<script>
    ...
    function retrm_out_btn_post_cancel_eCK(){
        ...
        let mymodal = new bootstrap.Modal(document.getElementById("retrm_out_PROGRESS_CNCL"), {backdrop: 'static', keyboard: false});
        mymodal.show()
        $.ajax({
            type: "POST",
    ...
    function retrm_out_txt_doprc_search_eKP(e) {
        if(e.key==='Enter') {
            ...
            $.ajax({
                ...
                data: {itemcd : itemcd, searchby: searchby , searchval :searchval.value },
                dataType: "json",
                success: function (response) {
    ...
    function retrm_out_btn_sorm_eCK(){        
        ...
        $.ajax({
            ...
            data: {itemcd: itemcd, bg: bisgrup, cuscd: retrm_out_inc_custcd  },
            dataType: "JSON",
            success: function (response) {
    ...
    function retrm_out_btn_post_eC() {
        ...
        if ( confirm('Are you sure ?') ) {
            const mymodal = new bootstrap.Modal(document.getElementById("retrm_out_inc_PROGRESS"), {backdrop: 'static', keyboard: false})
            mymodal.show()
        }
    }
    ...
    function retrm_out_e_posting(){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                retrm_out_inc_seconds = 0; retrm_out_inc_minutes = 0; retrm_out_inc_hours = 0
            }, error: function(xhr, xopt, xthrow){
                clearTimeout(retrm_out_inc_t)
                retrm_out_inc_timerspan.innerText = "00:00:00"
                retrm_out_inc_seconds = 0; retrm_out_inc_minutes = 0; retrm_out_inc_hours = 0
    ...
    function retrm_out_inc_z_btn_save_e_click() {
        ...
        if(confirm("Are You sure ?")){
            $.ajax({
                ...
                data: {inid : msj.value, innopen: mnopen, inaju: mnoaju.value, 
                ...
                intgldaftar: mtglpen,incona: mcona
                },
                dataType: "json",
                success: function (response) {
                    if(response[0].cd='11'){
    ...
    function retrm_out_inc_z_btn_save261_e_click(){
        ...
        if(confirm("Are You sure ?")){
            $.ajax({
                ...
                data: {inid : msj.value, innopen: mnopen, inaju: mnoaju.value, 
                    infromoffice: mfromoffice,inpurpose: mpurpose
                    , intgldaftar: mtglpen,incona: mcona, injenis_sarana: mejenis_sarana_angkut
                 },
                dataType: "json",
                success: function (response) {
                    if(response[0].cd='11'){
        ...
        if(confirm("Are You sure ?")){
            $.ajax({
                ...
                data: {inid : msj.value, innopen: mnopen, inaju: mnoaju.value, 
                    ...
                    innopen : mnopen, intglpen: mtglpen
                },
                dataType: "json",
                success: function (response) {
                    if(response[0].cd='11'){
    ...
    function retrm_out_txtxtsearch_eKP(e){
        if (e.key === 'Enter'){
            ...
            $.ajax({
                ...
                data: {inkey: mkeys, insearchby: ms_by, insearchperiod: searchperiod, inmonth: monthperiod, inyear: yearperiod, insearchtype: '0'  },
                dataType: "json",
                success: function (response) {
    ...
    function  retrm_out_f_getdetail(ptxid) {
        $.ajax({
            ...
            success: function (response) {
                ...
                for (let i = 0; i<ttlrows; i++){
                    newrow = tableku2.insertRow(-1)
                    newrow.onclick = (event) => {retrm_out_inc_tbl_tbody_tr_eC(event)}                    
                    newcell = newrow.insertCell(0)
                    newcell.classList.add('d-none')
                ...
                for (let i = 0; i<ttlrows; i++){
                    newrow = tableku2.insertRow(-1)                    
                    newrow.onclick = (event) => {retrm_out_inc_tbl1_tbody_tr_eC(event)}
                    newcell = newrow.insertCell(0)
                    newcell.classList.add('d-none')                    
    ...
    function retrm_out_btn_book_eC(){
        ...
        let mymodal = new bootstrap.Modal(document.getElementById("retrm_out_inc_PROGRESS_BOOK"), {backdrop: 'static', keyboard: false});
        mymodal.show()        
    ...
    function retrm_out_cscr_txtsearch_eKP(e){
        if(e.key==='Enter') {
            ...
            $.ajax({
                ...
                data: {search : e.target.value,  date0: date0},
                dataType: "json",
                success: function (response) {
