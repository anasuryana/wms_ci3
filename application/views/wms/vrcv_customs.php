        ...
        <div class="row" id="rcvcustoms_stack0">
            <div class="col-md-12 mb-1 text-center">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="rcvcustoms_mode3">Material Sample & <span title="Depuruntukan untuk bahan baku dan penolong tetapi tidak diinput di MEGA EMS">Other</span></label>
                </div>
            </div>
        </div>
