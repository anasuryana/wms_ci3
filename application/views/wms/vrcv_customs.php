...
<script>
    ...
    function rcvcustoms_ProcessExcel(data) {
        ...
        for (let i = 0; i < excelRows.length; i++) {
            ...
            $.ajax({
                ...
                data: {indo: mdo, initemcode: mitemcd, inhscode: mhscode
                ,inppn : mppn, inpph: mpph, innourut: mnomor_urut, inbm: mbm
                ,inrowid: i, inqty: mqty},
                dataType: "json",
                success: function (response) {
    ...
    function rcvcustoms_e_save(){
        ...
        $.ajax({
            ...
            data: {inbctype: mbctype, inbcno: mnoaju, inbcdate: mdate,inrcvdate: mrcvdate, inwh: ar_wh,
                inpo:ar_pono ,indo: mdo,inconaNum : mconaNum ,intpb: mtpb, inregno: mregno, inNW: m_nw, inGW: m_gw,
                ...
                instsrcv :zstsrcv, inbm : ar_bm, inppn: ar_ppn, inpph: ar_pph, innomorurut: ar_nourut, inbisgrup: mbisgrup },
            dataType: "json",
            success: function (response) {
    ...
    $("#rcvcustoms_txt_search").keypress(function (e) { 
        if(e.key==='Enter'){
            ...
            $.ajax({
                ...
                ,indatefilter: mdatefilter, inbisgrup: mbisgrup},
                dataType: "json",
                success: function (response) {
    ...
    function WMSGetDODetail(pdo){
        ...
        $.ajax({
            ...
            data: {indo: pdo, inbisgrup: mbisgrup},
            dataType: "json",
            success: function (response) {
                let ttlrows = response.length;
                if (ttlrows>0){
    ...
    function rcvcustoms_txtsearchPK_eKP(e){
        if(e.key === 'Enter'){
            ...
            $.ajax({
                ...
                data: {searchBy: '0', searchKey: msearchKey},
                dataType: "JSON",
                success: function (response) {
                    const ttlrows = response.data.length
                    ...
                    if( response.status[0].cd===1){
                        ...
                        for (let i = 0; i<ttlrows; i++){                            
                            ...
                            newcell = newrow.insertCell(0)
                            newcell.style.cssText = "cursor:pointer"
                            newcell.onclick = () => {rcvcustoms_load_data(response.data[i].MCONA_DOC)}
    ...
    function rcvcustoms_txt_search_1_eKP(e){
        if(e.key=='Enter') {
            ...
            $.ajax({
                ...
                data: {inid: mval, inby: mby, inpermonth: mpermonth, inyear: myear, inmonth: mmonth},
                dataType: "JSON",
                success: function (response) {
                    const ttlrows = response.data.length
    ...
    function rcvcustoms_po_txtsearch_eKP(e){
        if(e.key==='Enter'){
            ...
            $.ajax({
                ...
                data: {search : e.target.value, searchtype: '1'},
                dataType: "json",
                success: function (response) {
