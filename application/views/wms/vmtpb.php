            ...
            <div class="row">
                <div class="col">
                    <div class="input-group input-group-sm mb-1">
                        ...
                        <select id="tpbtype_srchby" class="form-control">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for(var i=0;i<ttlrows;i++){                        
                        ...
                        '<td style="white-space:nowrap">'+response[i].MTPB_CD.trim()+'</td>'+
                        '<td style="white-space:nowrap">'+response[i].MTPB_DESC+'</td>'+                        
                        '</tr>';
                    }                    
