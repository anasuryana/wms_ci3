        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-1">
                <div class="input-group input-group-sm mb-1">                    
                    ...
                    <input type="text" class="form-control" id="rcvfgprd_abn_txt_code" maxlength="100" readonly placeholder="code here..." required style="text-align:center">                      
...
<script>
    ...
    function rcvfgprd_abn_showinfoofus(){
        let mymodal = new bootstrap.Modal(document.getElementById("rcvfgprd_abn_modprevent"), {backdrop: 'static', keyboard: false});
        mymodal.show();                  
    }
    ...
    function rcvfgprd_abn_f_send(pkey){
        ...
        if(mkey.trim()!='' && rcvfgprd_abn_ismodalshown==false){
            ...
            $.ajax({
                ...
                data: {inkey: mkey, injob: mjob, infgtype: mtypefg, initemcd: mitem, inlot: mlotno, inqty : mqty, inremark: mremark, inremark_ka: mremark_ka, inismanual : ismanualselect, inreason: mreason.value},
                dataType: "json",
                success: function (response) {
