        ...
        <div class="row">
            <div class="col-md-12 mb-1">
                <div class="input-group">
                    ...
                    <textarea class="form-control" id="sup_taaddr" aria-label="Address" maxlength="150"></textarea>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 mb-1">
                <div class="input-group">
                    <span class="input-group-text">Address</span>
                    <textarea class="form-control" id="sup_taaddr2" aria-label="Address" maxlength="50"></textarea>
                </div>
            </div>
        </div>
        <div class="row">
...
<script>
                ...
                success: function (response) {
                    ...
                    for (let i = 0; i<ttlrows; i++){
                        ...
                        newcell.onclick = () => {
                            ...
                            $("#sup_taaddr2").val(response[i].MSUP_ADDR2);
    ...
    $("#sup_btnsave").click(function(){
        if(confirm("Are you sure ?")){
            ...
            let maddr   = sup_taaddr.value
            let maddr2   = sup_taaddr2.value
            ...
            $.ajax({
                ...
                data: {incd: mcd, incur: mcur, innm: mnm, inabbr: mabbr, inaddr: maddr,inaddr: maddr,mphone: mphone, mfax: mfax, mtax: mtax },
                dataType: "text",
                success: function (response) {
