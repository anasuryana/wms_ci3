        ...
        <div class="row" id="rsumsupinv_stack1">
            <div class="col-md-3 mb-1">
                <div class="input-group input-group-sm">
                    ...
                    <input type="text" class="form-control" id="rsumsupinv_txt_dt" readonly title="Receive date">
                </div>
            </div>
            <div class="col-md-3 mb-1">
                <div class="input-group input-group-sm">                    
                    <span class="input-group-text" >To</span>                    
                    <input type="text" class="form-control" id="rsumsupinv_txt_dt2" readonly title="Receive date">
                </div>
            </div>            
