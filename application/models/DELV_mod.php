...
class DELV_mod extends CI_Model
{
    ...
    {
        $this->db->select("DLV_SER,SISCN_DOC,SISCN_DOCREFF,rtrim(SER_ITMID) SER_ITMID,SER_DOC,RTRIM(MITM_ITMD1) MITM_ITMD1,RTRIM(MITM_ITMD2) MITM_ITMD2,SI_MDL,SISCN_SERQTY,SI_DOCREFFDT,DLV_INVNO, DLV_INVDT,DLV_SMTINVNO,
