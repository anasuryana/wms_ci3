...
class SER_mod extends CI_Model
{
    ...
    {
        $this->db->select("SER_ID,SER_ITMID,MITM_ITMD1,SER_PRDDT,SER_DOC,SER_PRDLINE,SER_PRDSHFT,SER_QTY,SER_SHEET,MCUS_CUSNM,MITM_STKUOM,SER_GRADE MBOM_GRADE,PDPP_BSGRP,SER_RMRK,SER_STATUS,PDPP_WORQT");
