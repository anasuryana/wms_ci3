...
class XWO_mod extends CI_Model {
    ...
    function selectLineWhereInModelProcessAndVersion($models,$models_process,$models_versions)
    {
    ...
    function selectProcessDetail($passyCode){
    ...
    function selectProcess($passyCode){
