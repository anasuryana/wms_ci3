...
class SI_mod extends CI_Model
{
    ...
    {
        $qry = "SELECT SI_ITMCD,MITM_ITMD1,SI_DOC,isnull(SISCN_SERQTY,0) SISCN_SERQTY,SER_DOC,SISCN_SER,SI_DOCREFFETA,SISCN_LUPDT,SI_BSGRP,DLV_ID, ISNULL(SI_OTHRMRK,SI_HRMRK) SI_OTHRMRK,ITH_LUPDT,SER_RMRK FROM SI_TBL
