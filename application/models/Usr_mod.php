...
class Usr_mod extends CI_Model {
    ...
    public function select_kitting($pyear){
        ...
        (select SPLSCN_USRID,concat(year(SPLSCN_LUPDT),'-',RIGHT(CONCAT('00',MONTH(SPLSCN_LUPDT)),2) ) YEARMONTH from  SPLSCN_TBL WHERE SPLSCN_USRID NOT IN ('1','ane') AND YEAR(SPLSCN_LUPDT) = 2021) V1
