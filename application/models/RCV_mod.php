...
class RCV_mod extends CI_Model {
    ...
    public function select_for_rmrtn_bytxid($pdoc){       
		$qry = "select RCV_DONO,RCV_RPNO,RTRIM(RCV_ITMCD) RCV_ITMCD,RCV_ZNOURUT,RCV_QTY,RCV_QTY DOCQTY,RCV_BCDATE,RCV_BCTYPE,RCV_KPPBC,RCV_PRPRC,RCV_HSCD,RCV_BM,MSUP_SUPCR from 
