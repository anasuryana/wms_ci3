...
class DLVRMDOC_mod extends CI_Model
{
    ...
    public function select_invoice($ptxid)
    {
        ...
        ,DLV_SMTINVNO,MCUS_CURCD,DLV_INVDT,DLV_NOPEN,DLV_ITMD1,DLV_ITMSPTNO,DLV_BCTYPE,DLV_DSCRPTN FROM
        ...
        ,DLV_ITMD1,DLV_ITMSPTNO,max(DLV_BCTYPE) DLV_BCTYPE,max(DLV_DSCRPTN) DLV_DSCRPTN FROM DLV_TBL 
