...
class DLVRMDOC_mod extends CI_Model {
    ...
    public function select_invoice($ptxid){
        ...
        ,DLVRMDOC_AJU,DLVRMDOC_DO from DLVRMDOC_TBL LEFT JOIN MITM_TBL ON DLVRMDOC_ITMID=MITM_ITMCD
        WHERE DLVRMDOC_TXID=?
        group by DLVRMDOC_ITMID,MITM_ITMD1, DLVRMDOC_PRPRC,DLVRMDOC_TXID,MITM_STKUOM,DLVRMDOC_TYPE,DLVRMDOC_NOPEN,DLVRMDOC_AJU,DLVRMDOC_DO) VINV
        LEFT JOIN (
