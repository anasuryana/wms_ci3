...
class DLVRMSO_mod extends CI_Model {
    ...
    public function select_invoice($ptxid){
        ...
        ,ISNULL(DLV_SMTINVNO,'') DLV_SMTINVNO,RTRIM(MCUS_CURCD) MCUS_CURCD,DLV_INVDT,isnull(DLV_NOPEN,'') DLV_NOPEN,DLV_ITMCD,DLV_ITMD1,DLV_ITMSPTNO,max(DLV_BCTYPE) DLV_BCTYPE FROM DLV_TBL 
