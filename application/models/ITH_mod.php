...
class ITH_mod extends CI_Model {
	...
	public function select_wo_side_detail($pdate,$passycode,$ppsn) {
		...
		LEFT JOIN (select PPSN1_WONO,RTRIM(MAX(PPSN1_PSNNO)) PPSN1_PSNNO from XPPSN1 group by PPSN1_WONO) VPSN ON PDPP_WONO=PPSN1_WONO		
		...
		ORDER BY PPSN1_PSNNO,PDPP_WONO DESC";		
		$query = $this->db->query($qry, [$pdate,$pdate]);
        return $query->result_array();
	}
