...
class ITH_mod extends CI_Model
{
    ...
    {
        $qry = "SELECT ITH_DATEC,ITH_DOC,DLV_CUSTDO,DLV_CONSIGN,NOMAJU,NOMPEN,INVDT,DLV_INVNO,DLV_SMTINVNO,ITH_ITMCD,ITMDESCD,DLVPRC_CPO,DLVPRC_QTY,DLVPRC_PRC,(DLVPRC_QTY*DLVPRC_PRC) AMOUNT,DLV_SMTINVNO,DLV_SPPBDOC,DLV_CUSTCD  FROM
        (select ITH_DATEC,max(DLV_CONSIGN) DLV_CONSIGN,max(DLV_INVDT) INVDT,ITH_ITMCD,MAX(RTRIM(MITM_ITMD1)) ITMDESCD,ITH_DOC,ABS(SUM(ITH_QTY)) DELQT,MAX(DLV_INVNO) DLV_INVNO, MAX(DLV_SMTINVNO) DLV_SMTINVNO
            ,MAX(DLV_ZNOMOR_AJU) NOMAJU,max(DLV_NOPEN) NOMPEN,MAX(DLV_CUSTDO) DLV_CUSTDO,MAX(DLV_SPPBDOC) DLV_SPPBDOC,MAX(DLV_CUSTCD) DLV_CUSTCD from v_ith_tblc
